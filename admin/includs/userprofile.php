...
if (isset($_SESSION['user'])) {
    ...
    $userImage = "uploads/" .htmlspecialchars( $_SESSION['user']['image']); 
    $userEmail = htmlspecialchars($_SESSION['user']['email']);
    $userImage = "images/" .htmlspecialchars( $_SESSION['user']['image']); // جلب رابط الصورة
...
<head>
    ...
    <link rel="stylesheet" href="assests/styleprof.css">
...
<body>
    ...
    <button type="submit" name="logout" value="1" style="border: none; background: none; color: inherit; font: inherit; cursor: pointer;">
        ...
        <span class="text">Logout</span>
                    ...
                    <span class="text" onclick="showfiles()">roles</span>
                </a>
                        ...
                        <div class="tab-pane fade active show" id="account-general">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mb-1" value="<?php echo $userEmail?>">
